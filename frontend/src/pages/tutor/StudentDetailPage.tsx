...
export function StudentDetailPage() {
    ...
    if (error || !student) {
        return (
            <div className="mx-auto max-w-3xl px-4 py-8">
                <Link to="/tutor" className="mb-6 inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground">
    ...
    return (
        <div className="mx-auto max-w-3xl px-4 py-8">
            ...
            <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex gap-2">
                    ...
                    <DeleteStudentDialog
                        student={student}
                        onDeleted={() => navigate("/tutor", { replace: true })}
                    />
                </div>
            </div>
        ...
        <div className="mt-8 rounded-xl border border-dashed p-6 text-center text-sm text-muted-foreground">
            Sessions and progress tracking for this student arrive in Phase 6.
        </div>
    </div>
    );
}